...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="../../demo1/dist/index.html" class="py-9 mb-5">
								<img alt="Logo" src="{{ URL::asset('assets/media/logos/logo-2.svg') }}" class="h-60px" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
                            ...
                            <form method="POST" action="{{ route('password.email') }}" class="form w-100">
								...
								<div class="fv-row mb-10">
									...
									<input class="form-control form-control-solid" type="email" value="{{ old('email') }}" name="email" required />
                                    @error('email')
		...
		<script src="{{ URL::asset('assets/js/custom/authentication/password-reset/password-reset.js') }}"></script>
